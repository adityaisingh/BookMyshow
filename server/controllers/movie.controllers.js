const getMovie = (req, res) => {
  const movies = [
    ...
    },
    {
      ...
      image:
        "https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:l-image,i-discovery-catalog@@icons@@like_202006280402.png,lx-24,ly-617,w-29,l-end:l-text,ie-OTEuNEsgTGlrZXM%3D,fs-29,co-FFFFFF,ly-612,lx-70,pa-8_0_0_0,l-end/et00352820-rauglgcvkc-portrait.jpg",
    },
    {
      title: "Meiyazhagan",
      genre: "Comedy/Drama",
